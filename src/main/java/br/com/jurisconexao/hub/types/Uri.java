package br.com.jurisconexao.hub.types;

public class Uri {
	

	public static String uri_auth = "http://localhost:8081";
	public static String uri_chat = "http://localhost:8082";
	public static String uri_nfe = "http://localhost:8082";
